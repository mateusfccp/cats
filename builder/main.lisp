...
(defun generate-table-cell (cat-name)
  (str-replace (str-replace (str-replace "<td align=\"center\"><a href=\"./cats/$3\">$1<strong>$2</strong></a></td>" "$1" (generate-img (get-cat-profile-picture cat-name))) "$2" cat-name) "$3" cat-name))
